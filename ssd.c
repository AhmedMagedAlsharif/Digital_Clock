...
void SSD_Update(void)
{
    ...
    {
        case 0:
            GPIO_Set_Pins(DISPLAY_DIGIT_1_PORT, DISPLAY_DIGIT_1_PIN & Hour_Mask);
            break;
        case 1:
            GPIO_Set_Pins(DISPLAY_DIGIT_2_PORT, DISPLAY_DIGIT_2_PIN & Hour_Mask);
            break;
        case 2:
            GPIO_Set_Pins(DISPLAY_DIGIT_3_PORT, DISPLAY_DIGIT_3_PIN & Minut_Mask);
            break;
        case 3:
            GPIO_Set_Pins(DISPLAY_DIGIT_4_PORT, DISPLAY_DIGIT_4_PIN & Minut_Mask);
            break;
    }
